...
amplitude_kwargs_kerr = {"specific_spins":
                    [0.80, 0.90, 0.95]} # For the sake of speed, only include set spin parameters
...
wave_generator_backwards = GenerateEMRIWaveform(KerrEquatorialEccentricWaveformBase,
                                                EMRIInspiral,
                                                AmpInterpKerrEqEcc,
                                                InterpolatedModeSum,
                                                ModeSelector,
...
wave_generator_forwards = GenerateEMRIWaveform(KerrEquatorialEccentricWaveformBase,
                                                EMRIInspiral,
                                                AmpInterpKerrEqEcc,
                                                InterpolatedModeSum,
                                                ModeSelector,
...
h_p_forward_fft = cp.fft.rfft(cp.roll(waveform_forward.real,-1)) # Roll array because numerical integrator not saving last point
h_p_back_reversed_fft = cp.fft.rfft(waveform_back.real[::-1]) # Reverse backwards integrated waveform
