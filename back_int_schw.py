...
traj_backwards = EMRIInspiral(func="SchwarzEccFlux", inspiral_kwargs = inspiral_kwargs) 
...
t_back, p_back, e_back, xi_f_back, Phi_phi_back, Phi_r_back, Phi_theta_back = traj_backwards(M, mu, 0.0, p_f, e_f, 1.0, 
...
traj_forwards = EMRIInspiral(func="SchwarzEccFlux", inspiral_kwargs = inspiral_kwargs) 

initial_p = p_back[-1]
initial_e = e_back[-1]

t_forward, p_forward, e_forward, Y_forward, Phi_phi_forward, Phi_r_forward, Phi_theta_forward = traj_forwards(M, mu, a, initial_p, initial_e, 1.0, 
                                             Phi_phi0=Phi_phi0, Phi_theta0=Phi_theta0, Phi_r0=Phi_r0, T=T )
...
wave_generator_backwards = GenerateEMRIWaveform("FastSchwarzschildEccentricFlux",
...
breakpoint()
waveform_back = wave_generator_backwards(M, mu, 0.0, p_f, e_f, 1.0, dist, qS, phiS, qK, phiK, 
...
inspiral_kwargs["integrate_backwards"] = False
wave_generator_forwards = GenerateEMRIWaveform("FastSchwarzschildEccentricFlux",
    inspiral_kwargs=inspiral_kwargs,
    amplitude_kwargs=amplitude_kwargs,
    Ylm_kwargs=Ylm_kwargs,
    sum_kwargs=sum_kwargs,
)
waveform_forward = wave_generator_forwards(M, mu, 0.0, initial_p, initial_e, 1.0, dist, qS, phiS, qK, phiK,
                          Phi_phi0=Phi_phi0, Phi_theta0=Phi_theta0, Phi_r0=Phi_r0,  dt=dt, T=T)
