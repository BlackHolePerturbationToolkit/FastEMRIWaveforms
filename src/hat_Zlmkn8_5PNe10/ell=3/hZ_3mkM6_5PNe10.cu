...
gsl_complex hZ_3mkM6(const int m, const int k, inspiral_orb_PNvar* PN_orb) { //

    gsl_complex hZ_3mkM6 = { 0.0 };
    ...
    if (PN_orb == NULL) {
        ...
        perror("Pointer errors: hZ_3mkM6");
        exit(1);
...
if (m == 3 && k == 4) { 
   ...
   Im_3mkM6  = -0.6468891313339304281904e-11 * v17 * y10 * (0.23490473335e11 * e10 - 0.7582561024e10 * e8 + 0.1056063232e10 * e6) / Yp3 * q4; 
    ...
    GSL_SET_COMPLEX(&hZ_3mkM6, Re_3mkM6, Im_3mkM6);
    return hZ_3mkM6;
