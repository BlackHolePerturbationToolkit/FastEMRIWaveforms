...
gsl_complex hZ_4mkM6(const int m, const int k, inspiral_orb_PNvar* PN_orb) { //

    gsl_complex hZ_4mkM6 = { 0.0 };
    ...
    if (PN_orb == NULL) {
        ...
        perror("Pointer errors: hZ_4mkM6");
        exit(1);
...
if (m == 4 && k == 4) { 
   ...
   Im_4mkM6  = 0.0e0; 
    ...
    GSL_SET_COMPLEX(&hZ_4mkM6, Re_4mkM6, Im_4mkM6);
    return hZ_4mkM6;
