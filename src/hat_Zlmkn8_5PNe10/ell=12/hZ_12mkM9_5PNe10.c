...
gsl_complex hZ_12mkM9(const int m, const int k, inspiral_orb_PNvar* PN_orb) { //

    gsl_complex hZ_12mkM9 = { 0.0 };
    ...
    if (PN_orb == NULL) {
        ...
        perror("Pointer errors: hZ_12mkM9");
        exit(1);
   ...
   // double K = PN_orb->PNK;
    ...
    GSL_SET_COMPLEX(&hZ_12mkM9, Re_12mkM9, Im_12mkM9);
    return hZ_12mkM9;
