...
gsl_complex hZ_8mkM9(const int m, const int k, inspiral_orb_PNvar* PN_orb) { //

    gsl_complex hZ_8mkM9 = { 0.0 };
    ...
    if (PN_orb == NULL) {
        ...
        perror("Pointer errors: hZ_8mkM9");
        exit(1);
...
if (m == 8 && k == 2) { 
   ...
   Im_8mkM9  = 0.0e0; 
    ...
    GSL_SET_COMPLEX(&hZ_8mkM9, Re_8mkM9, Im_8mkM9);
    return hZ_8mkM9;
