...
cdef extern from "../include/Inspiral5PN.hh":
    cdef cppclass Pn5CarrierWrap "Pn5Carrier":
        Pn5CarrierWrap(string func, bool enforce_schwarz_sep_)
        void dealloc()
...
cdef class pyPn5Generator:
    ...
    def __cinit__(self, func_name, enforce_schwarz_sep):
        self.g = new Pn5CarrierWrap(func_name.encode(), enforce_schwarz_sep)
