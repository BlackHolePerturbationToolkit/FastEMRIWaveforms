...
void load_and_interpolate_flux_data_RelKerr(struct interp_params *interps, const std::string &few_dir)
{
...
Relativistic_Kerr_Circ_Flux::Relativistic_Kerr_Circ_Flux(std::string few_dir)
{
    interps = new interp_params;
    load_and_interpolate_flux_data_RelKerr(interps, few_dir);
}

double Relativistic_Kerr_Circ_Flux::EdotPN(double r, double a)
{
...
#define Relativistic_Kerr_Circ_Flux_num_add_args 0
#define Relativistic_Kerr_Circ_Flux_equatorial
#define Relativistic_Kerr_Circ_Flux_circular
#define Relativistic_Kerr_Circ_Flux_file1 Kerr_flux_minus_PN1_l30_Has.dat
__deriv__ void Relativistic_Kerr_Circ_Flux::deriv_func(double *pdot, double *edot, double *xdot,
                                                       double *Omega_phi, double *Omega_theta, double *Omega_r,
                                                       double epsilon, double a, double p, double e, double x, double *additional_args)
{
...
// destructor
Relativistic_Kerr_Circ_Flux::~Relativistic_Kerr_Circ_Flux()
{
