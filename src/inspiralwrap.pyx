...
cdef extern from "../include/Inspiral.hh":
    cdef cppclass InspiralCarrierWrap "InspiralCarrier":
        InspiralCarrierWrap(string func, bool enforce_schwarz_sep_, bool integrate_backwards, int num_add_args_, bool convert_Y_, string few_dir)
        void dealloc()
...
cdef class pyInspiralGenerator:
    ...
    def __cinit__(self, func_name, enforce_schwarz_sep, integrate_backwards, num_add_args, convert_Y, few_dir):
        self.g = new InspiralCarrierWrap(func_name.encode(), enforce_schwarz_sep, integrate_backwards, num_add_args, convert_Y, few_dir)
