...
public:
  ...
  FastEMRIWaveforms(int time_batch_size_, int num_layers_, int *dim1_, int *dim2_,
    ...
    int max_input_len, int num_l_m_, int num_n_, fod delta_t_); // constructor (copies to GPU)

  void run_nn(cmplx *waveform, double p0, double e0, fod theta, fod phi, int* out_len);
