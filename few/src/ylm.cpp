...
std::complex<double> SpinWeightedSpheroidalHarmonic (int l, int m, double theta, double phi)
{
...
int main()
{
  ...
  for (int l=2; l<10+1; l++){
    for (int m=-l; m<l+1; m++){
        std::complex<double> check = SpinWeightedSpheroidalHarmonic<double> (l, m, theta, phi);
        printf("(%d, %d): %lf, %lf i\n", l, m, check.real(), check.imag());
    }
  }
}
*/
